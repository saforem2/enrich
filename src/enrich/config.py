...
STYLES: Dict[str, Style] = {
    ...
    'repr.brace': Style(bold=True, color="bright_black", dim=False),
    'repr.comma': Style(color="yellow"),
    'repr.colon': Style(color="green", bold=True),
    'repr.dash': Style(color='red', bold=True),
